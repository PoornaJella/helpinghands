...
<p id="demo"><h3><font size="" color="#99cc00">Click the button to get your coordinates:</p></font></h3>
<br>
...
<form method="post" action="uchangeloc2.jsp" onsubmit="getLocationDetails()">
