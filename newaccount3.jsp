...
st.executeUpdate("update orphanage set city='"+city+"', state='"+state+"', zip='"+zip+"', latitude='"+lat+"' , longitude='"+lon+"' where email='"+email+"' ");

//	response.sendRedirect("profilepic.jsp?id="+email+"");
	response.sendRedirect("newaccount.jsp?message="+email+"");
