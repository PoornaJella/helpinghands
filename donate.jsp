...
ResultSet rs=st.executeQuery("select email from orphanage");
while(rs.next())
{
...
<tr><th>*<th>Orphanage <th>Address<th>Distance (KM)<th>Details<th>
<%
...
<h4>
<a href="donate2.jsp?oemail=<%=rs.getString(1)%>"><u>Select</u></a>
</h4>
